...
export const THEME_BOOTSTRAP_SCRIPT = `(function(){try{var c=document.cookie;var tm=c.match(/(?:^|;\\s*)paleomem_theme=([^;]*)/);var t=tm?decodeURIComponent(tm[1]):'dark';var theme=t==='light'?'light':'dark';var root=document.documentElement;root.setAttribute('data-theme',theme);root.style.colorScheme=theme;var color=theme==='light'?'#ffffff':'#0b1118';root.style.backgroundColor=color;document.querySelectorAll('meta[name="theme-color"]').forEach(function(m){if(m.getAttribute('media'))m.remove();});var tc=document.querySelector('meta[name="theme-color"]');if(!tc){tc=document.createElement('meta');tc.name='theme-color';document.head.appendChild(tc);}tc.content=color;function paintBody(){if(document.body)document.body.style.backgroundColor=color;}paintBody();document.addEventListener('DOMContentLoaded',paintBody);var fm=c.match(/(?:^|;\\s*)paleomem_hebrew_font=([^;]*)/);var f=fm?decodeURIComponent(fm[1]):'modern';root.setAttribute('data-hebrew-font',f==='paleo'?'paleo':'modern');}catch(e){}})();`;